    ...
    >
      ...
      <div className="relative my-auto mx-auto w-full max-w-6xl px-6 pb-12 pt-24 sm:px-10 sm:pb-14 sm:pt-28 [@media(max-height:860px)]:sm:pb-8 [@media(max-height:860px)]:sm:pt-24">
          ...
          <motion.div
            ...
            className="mt-5 inline-flex flex-col gap-3 rounded-card border border-gold/30 bg-ink/25 px-5 py-4 backdrop-blur-sm sm:mt-6 sm:flex-row sm:items-center sm:gap-6 sm:px-7"
          >
            <div>
